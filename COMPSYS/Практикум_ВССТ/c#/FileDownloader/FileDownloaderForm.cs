...
namespace EPS.Libraries.ClientLibrary.HttpUtils
{
	...
	public class FileDownloaderForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.groupBox1.Text = "Статус закачек";
            // 
            // label6
            // 
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(403, 84);
            ...
            // lblDownlaodingTo
            // 
            this.lblDownlaodingTo.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // lblCurrentFile
            // 
            this.lblCurrentFile.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.label1.Text = "Этот файл:";
            this.label1.TextAlign = System.Drawing.ContentAlignment.BottomRight;
            // 
            // lblCurrentComplete
            // 
            this.lblCurrentComplete.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // lblOverallComplete
            // 
            this.lblOverallComplete.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // lblCurrentPercent
            // 
            this.lblCurrentPercent.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.label2.Text = "Программа для скачивания файлов";
            // 
            // button1
            // 
            ...
            this.Text = "Закачивальщик файлов";
		...
		private void MarshalDownloadComplete()
		{
			if(this.totalSize == this.completedSize)
			{
				...
				if(!unattended)
				{
					MessageBox.Show(this, "Закачка завершена.", "Закачивальщик файлов", MessageBoxButtons.OK, MessageBoxIcon.Information);
				}
				else
				{
					this.Close();
		...
		private void DoStartDownload(object state)
		{
			try
			{
				...
				foreach(DownloadURL url in urls)
				{
					...
					if(!progressKnown)
						throw new Exception("Неизвестный размер файла: " + url.URL);
		...
		private void btnPause_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				else if(btnPause.Text == "&Продолжить")
				{
					downloader.Resume();
					btnPause.Text = "&Пауза";
				}
		...
		sealed class DownloaderExceptionManager
		{
			...
			public static void Publish(Exception ex)
			{
				...
				MessageBox.Show(downloaderForm, ex.ToString(), "Ошибка закачки", MessageBoxButtons.OK, MessageBoxIcon.Error);
				downloaderForm.status = DownloadStatus.Failed;
				downloaderForm.canceled = true;
				downloaderForm.btnCancel.Text = "&Закрыть";
				downloaderForm.btnPause.Visible = false;
                downloaderForm.button1.Visible = false;
			}
		}
        ...
        {
            urls.Add(new DownloadURL(textBox1.Text,textBox2.Text));
            textBox1.Text="";
            textBox2.Text="";
